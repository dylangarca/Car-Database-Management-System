...
*/
$query = "SELECT id, task, due, DATE(completed) as completed_date, DATEDIFF(DATE(completed), due) as days_offset, assigned FROM M4_Todos WHERE is_complete =1 ORDER BY completed DESC, due DESC"; // edit this
$results = [];
try {
